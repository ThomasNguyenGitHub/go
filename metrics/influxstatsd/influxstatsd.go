...
import (
	...
	"github.com/ThomasNguyenGitHub/go/metrics"
	"github.com/ThomasNguyenGitHub/go/metrics/generic"
	"github.com/ThomasNguyenGitHub/go/metrics/internal/lv"
	"github.com/ThomasNguyenGitHub/go/metrics/internal/ratemap"
	"github.com/ThomasNguyenGitHub/go/util/conn"
)
...
func New(prefix string, logger log.Logger, lvs ...string) *Influxstatsd {
	...
	return &Influxstatsd{
		...
		gauges:     map[string]*gaugeNode{}, // https://github.com/ThomasNguyenGitHub/go/pull/588
		timings:    lv.NewSpace(),
