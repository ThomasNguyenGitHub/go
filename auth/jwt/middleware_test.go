...
var (
	...
	mapClaims      = jwt.MapClaims{"user": "go-base"}
	standardClaims = jwt.StandardClaims{Audience: "go-base"}
...
func TestJWTParser(t *testing.T) {
	...
	if !stdCl.VerifyAudience("go-base", true) {
	...
	if !custCl.VerifyAudience("go-base", true) {
