...
func TestHTTPClient(t *testing.T) {
	...
	client := gotransport.NewClient(
		"GET",
		mustParse(server.URL),
		encode,
		decode,
		gotransport.ClientBefore(gotransport.SetRequestHeader(headerKey, headerVal)),
		gotransport.ClientAfter(afterFunc),
	)
...
func TestHTTPClientBufferedStream(t *testing.T) {
	...
	client := gotransport.NewClient(
		...
		encode,
		decode,
		gotransport.BufferedStream(true),
	)
...
func TestClientFinalizer(t *testing.T) {
	...
	client := gotransport.NewClient(
		...
		encode,
		decode,
		gotransport.ClientFinalizer(func(ctx context.Context, err error) {
...
func TestSetClient(t *testing.T) {
	...
	client := gotransport.NewClient(
		...
		encode,
		decode,
		gotransport.SetClient(testHttpClient),
	).Endpoint()
...
func TestNewExplicitClient(t *testing.T) {
	...
	client := gotransport.NewExplicitClient(req, dec)
